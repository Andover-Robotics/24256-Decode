...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1227.421393562776; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3322.0260534341623; // x position of the perpendicular encoder (in tick units)
    }
